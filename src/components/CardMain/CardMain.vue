<template>
  <select v-model="selectedOption" id="sdf" class="sel" v-if="props.storeItems"  @change="optionSelected">
...
<div class="wrapper">
  <div
    ...
    v-for="item in props.storeItems"
    :key="item.id"
  >
    ...
    <div class="card-info">
      ...
      <div class="cart-info-section">
        <span class="button" v-if="!getAmount(item.id)" @click.stop="log(item)"
          >ADD TO CART</span
        >
        <div class="cart-info-section-amount" v-else>
